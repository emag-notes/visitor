...
class NumNode7 implements Node7 {
  ...
  @Override
  public <R, P, E extends Exception> R accept(Visitor7<R, P, E> visitor, P parameter) throws E {
...
class Calculator7 implements Visitor7<Integer, Void, RuntimeException> {
  @Override
